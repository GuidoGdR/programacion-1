...
def input_type(input_message="Ingrese un valor: ", input_type:Type=str, error_message="Valor incorrecto", validator:Callable[[Any], tuple[Union[str, None], Any]]=lambda x:(None, x)):
    while True:
